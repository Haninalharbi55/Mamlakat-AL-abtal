...
abstract class $AnswerEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, bool isCorrect});
}
...
class _$AnswerEntityImpl implements _AnswerEntity {
  const _$AnswerEntityImpl(
      {required this.id, required this.name, required this.isCorrect});
  ...
  @override
  String toString() {
    return 'AnswerEntity(id: $id, name: $name, isCorrect: $isCorrect)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, isCorrect);
...
abstract class _AnswerEntity implements AnswerEntity {
  const factory _AnswerEntity(
      ...
      required final bool isCorrect}) = _$AnswerEntityImpl;
